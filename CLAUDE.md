...
- 출처 배지는 7/24 제거(필수 아님 — 하루 마무리 카드에만 잔존, 유지/제거 결정 대기)
...
## 남은 일 (예선 제출 7/28 오전 11시 — 자료 4종: PPT·노션·깃허브·시연영상, 예선은 자료 평가·발표는 본선)
- **7/22**: ~~스플래시 스크린~~·~~에러 안내화면~~·~~데모 동선 점검(웹)~~ 완료
- **7/23**: ~~새벽: 루틴 카드 대개편·자율성 3종·카톡 재발송~~ → 오후: 실기기 전수 점검(새 카드·체크 해제·카톡 재발송 실수신), 여유 항목(완료 무지개·랜덤 힐링 문구)
- **7/24**: **설정 탭 '사용자 안내서'**(★ 매일 루틴·마음 날씨·쉬운 버전·다른 루틴으로 바꾸기·루틴 영역 7종·정원 등 기능 설명) + 개발 마무리(**코드 프리즈**) + 리포 정리 — 과거 커밋 작성자 정정·발표 문서 2건 히스토리 삭제(백업 후 force push), Solar 키 재발급·구키 폐기, README 정비
- **7/25**: 사용자 개인 일정 (작업 없음)
- **7/26**: 자료 제작 1일차 — PPT 뼈대·노션 구조·**시연영상 촬영** (데모: 온보딩→마음날씨→루틴 완료→카톡 수신→정원 맞이하기→기록 데모→앨범)
- **7/27**: 자료 제작 2일차 — PPT·노션 완성, 영상 편집, README 최종
- **7/28**: 오전 9~10시 제출 목표 (11시 마감), 최종 점검
- 예선 이후: 가을 에셋 세트(9/1 전), 닉네임 인라인 입력, Web Push 재검토
