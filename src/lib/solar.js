...
쉬어가기(휴식 선택) 상황의 원칙:
- 쉬어가기는 루틴 하나를 오늘 쉬는 것이지, 하루 전체를 쉬는 것이 아닙니다.
- 쉬는 것을 '결정을 잘했다', '멋지다', '승리', '고수' 같은 성취·칭찬으로 포장하지 않습니다. 쉬는 건 잘한 일도 못한 일도 아닌, 그냥 괜찮은 일입니다.
- 축하 대신 안심을 줍니다: 그런 날도 있다, 괜찮다, 부담 갖지 않아도 된다는 톤.
...
- 쉬어가기: '이건 오늘 쉬어가는 걸로요! 그런 날도 당연히 있는 거예요.'${COMMON_RULES}`,
...
- 쉬어가기: '오늘은 이 일을 쉬어갑니다. 그래도 하루는 충분히 굴러갑니다.'${COMMON_RULES}`,
...
- 쉬어가기: '이건 오늘 마음이 무거웠나 봐요. 쉬어가도 괜찮아요, 정말로요.'${COMMON_RULES}`,
}

const SITUATION_LABELS = {
  routine_done: '루틴을 완료했습니다',
  easy_done: '원래 루틴 대신 쉬운 버전을 완료했습니다',
  rest_day: '이 루틴 하나는 오늘 쉬어가기로 했습니다 (하루 전체를 쉬는 것이 아님)',
...
const FALLBACK = {
  유쾌: {
    ...
    rest_day:     ()  => `이건 오늘 쉬어가는 걸로 했네요. 그런 날도 당연히 있는 거예요.`,
  ...
  진중: {
    ...
    rest_day:     ()  => `오늘은 이 일을 쉬어갑니다. 그래도 하루는 충분히 굴러갑니다.`,
  ...
  다정: {
    ...
    rest_day:     ()  => `이건 오늘 쉬어가기로 했어요. 그래도 괜찮아요, 정말로요.`,
