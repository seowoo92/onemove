...
export const GARDEN_ELEMENTS = [
  ...
  { id: 'cloud', name: '구름', arrival: '구름이 두둥실 떠와요', threshold: 5, file: 'garden-summer-cloud.png', x: 50, y: 26, w: 28, motion: 'cross', shadow: 'none', z: 10 },
  ...
  { id: 'butterfly', name: '나비', arrival: '나비가 날아와요', threshold: 14, file: 'garden-summer-butterfly.png', x: 52, y: 50, w: 12, motion: 'fly', shadow: 'none', z: 45 },
  { id: 'tree-small', name: '작은 나무', arrival: '작은 나무가 자라나요', threshold: 20, file: 'garden-summer-tree-small.png', x: 79, y: 59, w: 39, motion: 'tree', shadow: 'ground-md', z: 25 },
  { id: 'sun', name: '햇님', arrival: '햇님이 떠올라요', threshold: 27, file: 'garden-summer-sun.png', x: 66, y: 17, w: 20, motion: 'breathe', shadow: 'none', z: 8 },
  ...
  { id: 'bird', name: '새', arrival: '새가 놀러 와요', threshold: 47, file: 'garden-summer-bird.png', x: 91, y: 80, w: 11, motion: 'nod', shadow: 'ground-sm', z: 44 },
  ...
  { id: 'tree-big', name: '큰 나무', arrival: '큰 나무가 우뚝 서요', threshold: 75, file: 'garden-summer-tree-big.png', x: 22, y: 55, w: 42, motion: 'tree', shadow: 'ground-lg', z: 24 },
]
