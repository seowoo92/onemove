...
export const GARDEN_ELEMENTS = [
  { id: 'sprout', name: '새싹', arrival: '새싹이 돋아나요', threshold: 2, file: 'garden-summer-sprout.png', x: 14, y: 85, w: 14, motion: 'sway', shadow: 'ground-sm', z: 32 },
  { id: 'butterfly', name: '나비', arrival: '나비가 날아와요', threshold: 5, file: 'garden-summer-butterfly.png', x: 44, y: 50, w: 12, rotate: -15, motion: 'fly', shadow: 'none', z: 45 },
  { id: 'flower-a', name: '수국', arrival: '수국이 피어나요', threshold: 9, file: 'garden-summer-flower-a.png', x: 47, y: 66, w: 19, motion: 'sway', shadow: 'ground-sm', z: 18 },
  { id: 'bird', name: '새', arrival: '새가 놀러 와요', threshold: 14, file: 'garden-summer-bird.png', x: 91, y: 80, w: 11, motion: 'nod', shadow: 'ground-sm', z: 44 },
  { id: 'sun', name: '햇님', arrival: '햇님이 떠올라요', threshold: 20, file: 'garden-summer-sun.png', x: 66, y: 17, w: 20, motion: 'breathe', shadow: 'none', z: 8 },
  { id: 'cloud', name: '구름', arrival: '구름이 두둥실 나타나요', threshold: 27, file: 'garden-summer-cloud.png', x: 47, y: 29, w: 28, motion: 'cross', shadow: 'none', z: 10 },
  { id: 'flower-b', name: '해바라기', arrival: '해바라기가 피어나요', threshold: 36, file: 'garden-summer-flower-b.png', x: 74, y: 78, w: 28, motion: 'sway-alt', shadow: 'ground-md', z: 35 },
  { id: 'tree-small', name: '작은 나무', arrival: '작은 나무가 자라나요', threshold: 47, file: 'garden-summer-tree-small.png', x: 79, y: 57, w: 33, motion: 'tree', shadow: 'ground-md', z: 25 },
  { id: 'pond', name: '연못', arrival: '연못이 생겨나요', threshold: 60, file: 'garden-summer-pond.png', x: 45, y: 88, w: 36, motion: 'pond', shadow: 'ground-wide', z: 20, wide: true },
  { id: 'tree-big', name: '큰 나무', arrival: '큰 나무가 생겨나요', threshold: 75, file: 'garden-summer-tree-big.png', x: 22, y: 55, w: 38, motion: 'tree', shadow: 'ground-lg', z: 24 },
]
