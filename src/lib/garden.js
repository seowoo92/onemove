...
export const GARDEN_ELEMENTS = [
  ...
  { id: 'butterfly', name: '나비', arrival: '나비가 날아와요', threshold: 5, file: 'garden-summer-butterfly.png', x: 52, y: 50, w: 12, motion: 'fly', shadow: 'none', z: 45 },
  { id: 'flower-a', name: '수국', arrival: '수국이 피어나요', threshold: 9, file: 'garden-summer-flower-a.png', x: 47, y: 69, w: 19, motion: 'sway', shadow: 'none', z: 18 },
  ...
  { id: 'cloud', name: '구름', arrival: '구름이 두둥실 나타나요', threshold: 27, file: 'garden-summer-cloud.png', x: 50, y: 26, w: 28, motion: 'cross', shadow: 'none', z: 10 },
  { id: 'flower-b', name: '해바라기', arrival: '해바라기가 피어나요', threshold: 36, file: 'garden-summer-flower-b.png', x: 77, y: 83, w: 28, motion: 'sway-alt', shadow: 'ground-md', z: 35 },
  { id: 'tree-small', name: '작은 나무', arrival: '작은 나무가 자라나요', threshold: 47, file: 'garden-summer-tree-small.png', x: 79, y: 59, w: 39, motion: 'tree', shadow: 'ground-md', z: 25 },
  { id: 'pond', name: '연못', arrival: '연못이 생겨나요', threshold: 60, file: 'garden-summer-pond.png', x: 50, y: 88, w: 40, motion: 'pond', shadow: 'ground-wide', z: 20, wide: true },
  { id: 'tree-big', name: '큰 나무', arrival: '큰 나무가 생겨나요', threshold: 75, file: 'garden-summer-tree-big.png', x: 22, y: 55, w: 42, motion: 'tree', shadow: 'ground-lg', z: 24 },
]
