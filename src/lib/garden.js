...
export const GARDEN_ELEMENTS = [
  { id: 'sprout', name: '새싹', threshold: 2, file: 'garden-summer-sprout.png', x: 29, y: 86, w: 11, motion: 'sway', shadow: 'ground-sm', z: 32 },
  { id: 'cloud', name: '구름', threshold: 5, file: 'garden-summer-cloud.png', x: 27, y: 18, w: 28, motion: 'drift', shadow: 'none', z: 10 },
  { id: 'flower-a', name: '여름 꽃', threshold: 9, file: 'garden-summer-flower-a.png', x: 19, y: 78, w: 16, motion: 'sway', shadow: 'ground-sm', z: 34 },
  { id: 'butterfly', name: '나비', threshold: 14, file: 'garden-summer-butterfly.png', x: 45, y: 50, w: 12, motion: 'fly', shadow: 'none', z: 45 },
  ...
  { id: 'flower-b', name: '들꽃', threshold: 36, file: 'garden-summer-flower-b.png', x: 78, y: 84, w: 15, motion: 'sway-alt', shadow: 'ground-sm', z: 35 },
  { id: 'bird', name: '새', threshold: 47, file: 'garden-summer-bird.png', x: 90, y: 84, w: 11, motion: 'nod', shadow: 'ground-sm', z: 44 },
  { id: 'pond', name: '연못', threshold: 60, file: 'garden-summer-pond.png', x: 54, y: 88, w: 40, motion: 'pond', shadow: 'ground-wide', z: 20, wide: true },
