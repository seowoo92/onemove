...
export const GARDEN_ELEMENTS = [
  { id: 'sprout', name: '새싹', threshold: 2, file: 'garden-sprout.png', x: 29, y: 86, w: 11, motion: 'sway', shadow: 'ground-sm', z: 32 },
  { id: 'cloud', name: '구름', threshold: 5, file: 'garden-cloud.png', x: 27, y: 18, w: 28, motion: 'drift', shadow: 'none', z: 10 },
  { id: 'flower-a', name: '여름 꽃', threshold: 9, file: 'garden-flower-a.png', x: 19, y: 78, w: 16, motion: 'sway', shadow: 'ground-sm', z: 34 },
  { id: 'butterfly', name: '나비', threshold: 14, file: 'garden-butterfly.png', x: 45, y: 50, w: 12, motion: 'fly', shadow: 'none', z: 45 },
  { id: 'tree-small', name: '작은 나무', threshold: 20, file: 'garden-tree-small.png', x: 80, y: 57, w: 30, motion: 'tree', shadow: 'ground-md', z: 25 },
  { id: 'sun', name: '햇님', threshold: 27, file: 'garden-sun.png', x: 66, y: 17, w: 20, motion: 'breathe', shadow: 'none', z: 8 },
  { id: 'flower-b', name: '들꽃', threshold: 36, file: 'garden-flower-b.png', x: 78, y: 84, w: 15, motion: 'sway-alt', shadow: 'ground-sm', z: 35 },
  { id: 'bird', name: '새', threshold: 47, file: 'garden-bird.png', x: 90, y: 84, w: 11, motion: 'nod', shadow: 'ground-sm', z: 44 },
  { id: 'pond', name: '연못', threshold: 60, file: 'garden-pond.png', x: 54, y: 88, w: 40, motion: 'pond', shadow: 'ground-wide', z: 20, wide: true },
  { id: 'tree-big', name: '큰 나무', threshold: 75, file: 'garden-tree-big.png', x: 22, y: 55, w: 42, motion: 'tree', shadow: 'ground-lg', z: 24 },
]
